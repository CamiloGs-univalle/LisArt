// src/components/shop/SocialLinks.jsx
import './SocialLinks.css'

// ── Cambia los href por tus links reales ──────────
const SOCIALS = [
    {
        name: 'WhatsApp',
        color: '#25D366',
        href: 'https://wa.me/573044955084',
    ...
    },
    {
        ...
        href: 'https://www.instagram.com/creaciones.lisart/',
    ...
    },
    {
        name: 'TikTok',
        color: '#010101',
        href: 'https://www.tiktok.com/@creaciones.lisart?_r=1&_t=ZS-98hLOOIeDth',
        icon: <svg viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.75a4.85 4.85 0 01-1.01-.06z" /></svg>
    },
    {
        name: 'Facebook',
        color: '#1877F2',
        href: 'https://www.facebook.com/share/1FHo3H2Qgf/',
...
function SocialLinks() {
    return (
        <div className="social-wrapper">
            <p className="social-label">¡Síguenos en redes! 💕</p>
